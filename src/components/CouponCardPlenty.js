...
export default function CouponCardPlenty(props) {
...
//setWalletColor
  ...
  return (
      <TouchableOpacity onPress={()=>showMe()} style={{marginVertical:10}}>
    
          <Image
        source={require('../../assets/coupons/1.png')} 
        style={{width:'100%', height:130, resizeMode:'stretch', borderRadius:20}}
        />
   <View style={{width:40, height:40, top:40, borderRadius:20, right:-15, 
    backgroundColor:'white', justifyContent:'center', position:'absolute', zIndex:8,}}>

   </View>
   <View style={{width:40, height:40, top:40, borderRadius:20, left:-15, 
    backgroundColor:'white', justifyContent:'center', position:'absolute', zIndex:8,}}>

   </View>
   
   <Text style={{fontSize:20, color:'black',width:'70%',
   fontFamily:'Pacifico_400Regular', position:'absolute', top:20, left:40}}> 
   10% Off</Text>

   <Text style={{fontSize:14, color:'black',width:'70%',
   fontFamily:'Kalam_400Regular', position:'absolute', top:60, left:40}}> 
